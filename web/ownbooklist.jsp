...
%>
	<div class="gallery">
            ...
            <font size="5" ><%=s%></font>
             <font size="5" color="blue"><a href='modifybook.jsp?bkk2=<%=s%>&role="book6"'>Modify</a></font>
            <br>
             <font size="6" color="red" style="bold">Author Name :</font>
            <font size="5" ><%=s1%></font>
             <font size="5" color="blue"><a href='modifybook.jsp?bkk2=<%=s%>&role="book1"'>Modify</a></font>
            <br>
             <font size="6" color="red" style="bold">Price :</font>
            <font size="5" ><%=s3%></font>
             <font size="5" color="blue"><a href='modifybook.jsp?bkk2=<%=s%>&role="book2"'>Modify</a></font>
             <br>
             <font size="6" color="red" style="bold">Genre :</font>
            <font size="5" ><%=s4%></font>
             <font size="5" color="blue"><a href='modifybook.jsp?bkk2=<%=s%>&role="book3"'>Modify</a></font>
            <br>
            ...
            <font size="5" ><%=s5%></font>
             <font size="5" color="blue"><a href='modifybook.jsp?bkk2=<%=s%>&role="book5"'>Modify</a></font>
            <br>
	  <div class="desc">
          ...
          <br><br>
            ...
            <font size="5" color="blue"><a href='deletebook.action?bkk1=<%=s%>'>Delete</a></font>
